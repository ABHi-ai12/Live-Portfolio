    ...
    <AnimatePresence>
      {isLoading && (
        <motion.div
          ...
          className="fixed inset-0 w-full h-screen bg-[var(--theme-color)] z-[100000] flex items-center justify-center"
        >
          {/* Logo Container */}
          <motion.div 
          ...
          >
            ...
            <div className="text-red-900/30">
              Abhinav<span className="text-red-900/30">.</span>
            </div>
            ...
            >
              Abhinav<span className="text-black">.</span>
            </motion.div>
          </motion.div>
