...
const defaultHomeData = {
  ...
  shortDescription: 'I build fast, scalable, and modern web applications using React, Node.js, and Tailwind CSS.',
  heroBackground: '/videos/hero-reel.mp4',
  profileImage: '/src/assets/about/image.png',
